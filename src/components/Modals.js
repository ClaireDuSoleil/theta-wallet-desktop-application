...
import ExtraWalletReceiveAddressesModal from '../modals/ExtraWalletReceiveAddressesModal';
...
const ModalComponentByType = {
  ...
  [ModalTypes.EXTRA_WALLET_RECEIVE_ADDRESSES]: ExtraWalletReceiveAddressesModal,
};
  ...
  render() {
    ...
    return (
      <ReactModal
        ...
        className="Modal"
      >
        {modal && <ModalComponent closeModal={this.props.closeModal} {...modal.props} />}
      </ReactModal>
    );
  }
}
...
class Modals extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <ModalContainer modal={modal1} closeModal={this.closeModal} />
        <ModalContainer modal={modal2} closeModal={this.closeModal} />
      </div>
    );
  }
}
